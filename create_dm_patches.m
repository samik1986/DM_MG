    ...
    for i = 1 : 256 : size(img,1)
        for j = 1 : 256 : size(img,2)
            if (i+255)<=size(img,1) && (j+255)<=size(img,2)
                ...
                imwrite(patch1*255, ['/home/samik/mnt/gpu3/mnt/disk128/main/training_data/training_data/STP/405_ann/' direc(d).name(1:end-4) '_' num2str(i) '_' num2str(j) '.tif']);
                imwrite(patch2*255, ['/home/samik/mnt/gpu3/mnt/disk128/main/training_data/training_data/STP/405_imgs/' direc(d).name(1:end-4) '_' num2str(i) '_' num2str(j) '.tif']);
                imwrite(patch3, ['/home/samik/mnt/gpu3/mnt/disk128/main/training_data/training_data/STP/405_dimo_no_simp/' direc(d).name(1:end-4) '_' num2str(i) '_' num2str(j) '.tif']);
                imwrite(patch4, ['/home/samik/mnt/gpu3/mnt/disk128/main/training_data/training_data/STP/405_simp_v2/' direc(d).name(1:end-4) '_' num2str(i) '_' num2str(j) '.tif']);
